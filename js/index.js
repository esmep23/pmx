...
function uploadPhoto() {
    ...
    var data = {
        ...
        question_4_1 : $('#checkbox-h-4a').prop('checked'),
        question_4_2 : $('#checkbox-h-4b').prop('checked'),
        question_4_3 : $('#checkbox-h-4c').prop('checked'),
        question_4_4 : $('#checkbox-h-4d').prop('checked'),
        question_5 : $('input[name=question5]:checked').val(),
        question_5_text : $('#txt_promocion').val(),
        ...
        question_8_text : $('#txt_aspecto_promotor').val(),
        question_9 : $('#txt_ubicacion_promotor').val(),
        image: 'false',
    };
